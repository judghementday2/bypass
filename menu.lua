...
do -- menu
    ...
    function sections:toggle(properties)
        ...
        local function set_state()
            ...
            --
            tween_service:Create(toggle_bg, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), { BackgroundColor3 = toggle.toggled and Color3.fromRGB(200, 200, 200) or UI.themes.outline }):Play()
