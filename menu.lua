...
do -- menu
    ...
    function sections:toggle(properties)
        ...
        local function set_state()
            ...
            tween_service:Create(accent_bg, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), { BackgroundColor3 = toggle.toggled and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(125, 125, 125) }):Play()
        end
